...
def main():
    ...
    data_transform = {
        ...
        "val": transforms.Compose([transforms.Resize((224, 224)),  # cannot 224, must (224, 224)
                                   transforms.ToTensor(),
                                   transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))])}
    data_root = r"/home/xiaoxie/data/tzc/domain_adaptation/dataA"
    ...
    test_dataset = datasets.ImageFolder(root=  r"/home/xiaoxie/data/tzc/domain_adaptation/dataB/OCT/OCTB",
                                            transform=data_transform["val"])
    ...
    for epoch in range(epochs):
        ...
        print('  test_accuracy: %.3f' %
              (  acc_test))
        writer.add_scalar("test acc/epoch", acc_test, epoch)
    writer.close()

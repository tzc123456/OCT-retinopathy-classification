...
def main():
    ...
    data_root = r"/home/xiaoxie/data/tzc/domain_adaptation/DA/data/B"
    ...
    DAmodel = models.TransferNet(3, device=device, base_net="resnet50", transfer_loss='adv')

    # load model weights
    weights_path = "./DANNab.pth"

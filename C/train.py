...
def main():
    ...
    data_transform = {
        ...
        "val": transforms.Compose([transforms.Resize((224, 224)),  # cannot 224, must (224, 224)
                                   transforms.ToTensor(),
                                   transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))])}
    data_root = r"/home/xiaoxie/data/tzc/domain_adaptation/dataC"
    ...
    # validate_dataset = datasets.ImageFolder(root="/home/xiaoxie/data/tzc/domain_adaptation/DA/data/C",
    #                                         transform=data_transform["val"])
